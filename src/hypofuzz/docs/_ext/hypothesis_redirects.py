# originally vendored from https://github.com/documatt/sphinx-reredirects under
# the MIT license, with thanks
#
# currently vendored from
# https://github.com/HypothesisWorks/hypothesis/blob/master/hypothesis-python/docs/_ext/hypothesis_redirects.py
# and may be out of date with that code
...
class Reredirects:
    ...
    def docname_out_path(self, docname: str, suffix: str) -> Sequence[str]:
        ...
        out_uri = self.app.builder.get_target_uri(docname=docname)
...
def collect_redirects_for_linkcheck(app: Sphinx) -> None:
